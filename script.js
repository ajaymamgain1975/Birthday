...
function initCountdown() {
    // Birthday: June 30, 2026 at midnight IST
    const birthday = new Date('2026-06-30T00:00:00+05:30');
    ...
    function updateCountdown() {
        ...
        if (diff <= 0) {
            ...
            messageEl.innerHTML = `
                <strong style="font-size: 1.3rem; color: var(--rose-gold-dark);">
                    🎉 आज माँ का जन्मदिन है! Happy Birthday Maa! 🎂
                </strong>
            `;
            return;
        }
...
function launchConfetti() {
    ...
    const colors = [
        '#b76e79', '#d4af37', '#f4c2c2', '#e8a0b4', 
        '#f0d68a', '#ff69b4', '#ffd700', '#ff6b6b',
        '#c77a8e', '#daa520'
    ];
...
/* ═══════════════════════════════════════════════════════
   EASTER EGG: Konami-style heart burst on triple-click
   ═══════════════════════════════════════════════════════ */
let clickCount = 0;
let clickTimer;
...
console.log('%c💕 Happy Birthday Maa! Made with love by Atharv 💕', 
    'background: linear-gradient(135deg, #b76e79, #d4af37); color: white; padding: 10px 20px; font-size: 16px; border-radius: 8px;');
